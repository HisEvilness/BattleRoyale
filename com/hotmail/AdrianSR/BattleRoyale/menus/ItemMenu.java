...
public class ItemMenu {
	...
	/**
	 * Sets the {@link com.hotmail.AdrianSRJose.AnniPro.itemMenus.MenuItem} 
	 * of a slot.
	 * <p>
	 * @param position The slot position.
	 * <p>
	 * @param menuItem The {@link com.hotmail.AdrianSRJose.AnniPro.itemMenus.MenuItem}.
	 * <p>
	...
	/**
	 * Add a {@link com.hotmail.AdrianSRJose.AnniPro.itemMenus.MenuItem} 
	...
	public void open(Player player) {
		...
		if (player != null && player.isOnline()) {
			if (!ItemMenuListener.getInstance().isRegistered(BattleRoyale.getInstance())) {
				ItemMenuListener.getInstance().register(BattleRoyale.getInstance());
			}
			...
			if (slot >= 0 && slot < size.getSize() && items[slot] != null) {
				...
				if (itemClickEvent.willUpdate()) {
					...
					if (itemClickEvent.willClose() || itemClickEvent.willGoBack()) {
						...
						Bukkit.getScheduler().scheduleSyncDelayedTask(BattleRoyale.getInstance(), new Runnable() {
							@Override
							public void run() {
