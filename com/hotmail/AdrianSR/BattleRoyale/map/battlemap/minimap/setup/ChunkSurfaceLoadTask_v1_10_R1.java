 ...
 */
class ChunkSurfaceLoadTask_v1_10_R1 extends ChunkSurfaceLoadTaskBase {
	
	public ChunkSurfaceLoadTask_v1_10_R1 ( int x , int z , DataInputStream input , Heightmap heightmap ) {
